...
const CheckOut = () => {
  ...
  // FIXED: Calculate cart total properly
    ...
    try {
      const orderData = {
        ...
        items: cart.map((item) => ({
          ...
          image_url: item.image || item.image_url, // FIXED: Try both image and image_url
        })),
      ...
      <div className="bg-gray-100 min-h-screen flex flex-col">
        <div className="flex-1 container mx-auto px-4 py-12">
          <div className="text-center py-12 bg-white rounded-lg shadow-md max-w-2xl mx-auto">
            ...
            <Link to="/" className="inline-block bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition">
              Continue Shopping
            </Link>
          </div>
        </div>
          ...
          <div className="lg:w-2/3">
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <div className="flex mb-6">
                <div className={`flex-1 text-center ${step >= 1 ? "text-black" : "text-gray-400"}`}>
                  <div className={`w-8 h-8 rounded-full mx-auto flex items-center justify-center ${step >= 1 ? "bg-black text-white" : "bg-black text-gray-500"}`}>1</div>
                  <p className="text-sm mt-2">Personal Info</p>
                </div>
                <div className={`flex-1 text-center ${step >= 2 ? "text-black" : "text-gray-400"}`}>
                  <div className={`w-8 h-8 rounded-full mx-auto flex items-center justify-center ${step >= 2 ? "bg-black text-white" : "bg-gray-200 text-gray-500"}`}>2</div>
                  <p className="text-sm mt-2">Shipping</p>
                </div>
                <div className={`flex-1 text-center ${step >= 3 ? "text-black" : "text-gray-400"}`}>
                  <div className={`w-8 h-8 rounded-full mx-auto flex items-center justify-center ${step >= 3 ? "bg-black text-white" : "bg-gray-200 text-gray-500"}`}>3</div>
              ...
              {step === 3 && (
                <div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-gray-400">
              ...
              <div className="flex justify-between mt-8">
                ...
                {step < 3 ? (
                  <button onClick={handleNextStep} className="ml-auto px-6 py-2 bg-black text-white rounded-lg font-semibold hover:bg-gray-300 transition">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="ml-auto px-6 py-2 bg-black text-white rounded-lg font-semibold hover:bg-gray-300 transition disabled:opacity-50"
                  >
                    {loading ? (
                      <>
              ...
              <div className="space-y-3 mb-4 max-h-64 overflow-y-auto">
                {cart.map((item) => (
                  <div key={item.id} className="flex gap-3">
                    {/* FIXED: Use item.image instead of item.image_url */}
                    <img 
